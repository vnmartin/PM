...
<?php $select3 = mysql_query("SELECT * FROM private WHERE person='$row[name]' AND person_delete='No' ORDER BY id DESC LIMIT $from, $blog_postnumber");
...
<?php
$total_results = mysql_fetch_array(mysql_query("SELECT COUNT(*) as num FROM private WHERE person='$row[name]' AND person_delete='No';"));

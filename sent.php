...
$id = (int)$_GET['id'];
  $getdata = mysql_query("SELECT * FROM private WHERE id='$id'");
...
include ("mytcg/bbcode_replace.php");
...
<input type="hidden" name="person" id="person" value="<?php echo $name; ?>"/>
...
<tr><td><?php include("mytcg/bbcode.php"); ?></td></tr>
...
<?php } } else { echo "<B>Error</b>"; }
  ...
  ?>
  <h1>Error</h1>
  You are trying to view a message that is not yours.
  <?php
}
include("footer.php"); ?>